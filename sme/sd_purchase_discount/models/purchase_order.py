...
class PurchaseOrder(models.Model):
    ...
    def _check_order_lines_disc(self):
        """
...
class PurchaseOrderLine(models.Model):
    ...
    # Constrain That Discount cannot be greater than 100
    _sql_constraints = [
        (
            "discount_limit",
    ...
    @api.onchange("product_qty", "product_uom", "partner_id")
