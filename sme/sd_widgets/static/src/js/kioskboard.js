          ...
          if (keyboardType === kioskBoardTypes.Numpad) {
            ...
            for (var key3 in kioskBoardNumpadKeysObject) {
              if (Object.prototype.hasOwnProperty.call(kioskBoardNumpadKeysObject, key3)) {
                ...
                //TODO: Redefined backspaceKey to decrease its width
                backspaceKey = '<span style="width:calc(33.3333% - 16px);font-family:' + fontFamily + ',sans-serif;font-weight:' + fontWeight + ';font-size:' + fontSize + ';" class="kioskboard-key-backspace">' + kioskBoardIconBackspace(keysIconWidth, keysIconColor) + '</span>';
