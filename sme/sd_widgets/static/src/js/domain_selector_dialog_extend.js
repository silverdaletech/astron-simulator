odoo.define("web.DomainSelectorDialogs", function (require) {
    "use strict";

    var core = require("web.core");
    var Dialog = require("web.Dialog");
    var DomainSelector = require("web.DomainSelectors");
    var _t = core._t;

    var DomainSelectorDialogs = Dialog.extend({
