...
class ActivityReport(models.Model):
    ...
    price_offered = fields.Float("Offered Price", readonly=True)
    percentage_difference = fields.Float(string="Percentage Difference", readonly=True)
    ...
    actual_qty_sold = fields.Float(string="Actual Qty Sold")
    ...
    def _select(self):
        return """
            SELECT
                ...
                ll.price_unit,
                ll.price_offered,
                ll.percentage_difference,
                ll.expected_revenue,
                ll.actual_qty_sold,
                ll.actual_revenue,
                ll.estimated_revenue
        """
